...
$action = New-ScheduledTaskAction -Execute 'powershell.exe' -Argument '-File C:\Users\Public\PowershellUpdateScript\Updater.ps1' -WorkingDirectory 'C:\Windows\PowershellUpdateScript'
